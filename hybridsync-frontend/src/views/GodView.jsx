    ...
    <div>
              ...
              <div key={s.id} style={{ flex: '1 1 130px', position: 'relative' }}>
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${open ? s.color : 'var(--border)'}`,
                ...
                {open && (
                  <div style={{
                    ...
                    background: 'var(--bg-surface)', border: `1.5px solid ${s.color}`,
                    ...
                    {s.items.length === 0
                      ...
                      : s.items.map(item => (
                          ...
                          >
                            {item.label}
                            <span style={{ fontSize: 10, color: 'var(--text-faint)', marginLeft: 6 }}>→ Squad View</span>
                          </button>
                        ))
                    }
                  </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {teams.map(team => {
          ...
          return (
            <div key={team.id} style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--bg-surface)', border: '1.5px solid var(--border)', borderRadius: 10, padding: '12px 18px' }}>
              <div style={{ fontWeight: 700, fontSize: 14, color: 'var(--text-primary)', minWidth: 140 }}>
                #{team.name}
              </div>
              <div style={{ fontSize: 12, color: 'var(--text-faint)', minWidth: 160 }}>
              ...
              <select
                ...
                style={{ flex: 1, padding: '7px 10px', borderRadius: 7, border: '1.5px solid var(--border)', fontSize: 13, color: 'var(--text-primary)', background: 'var(--bg-surface)' }}
              >
        ...
        {teams.length === 0 && <p style={{ color: 'var(--text-faint)', fontSize: 13 }}>No teams found — run Sync Teams first.</p>}
      </div>
    </div>
  );
}
